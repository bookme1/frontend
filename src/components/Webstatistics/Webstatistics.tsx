      ...
      <div className="w-max">
        <ul className="flex-col ml-20  text-gray-500 ">
          ...
          <li className="flex gap-3 mb-6 cursor-pointer hover:text-green-900  ">
            <button className="flex gap-2 justify-center items-center ">
              <Icon name="group" />
              <a href="/admin/users" className="hover:text-green-900">
                Користувачі
              </a>
            </button>
          </li>
          <li className="flex gap-3 mb-6 cursor-pointer hover:text-green-900  ">
            <button className="flex gap-2 justify-center items-center ">
              <FaCodePullRequest />
              <a href="/admin/ping" className="hover:text-green-900">
                Elibri Запити
              </a>
            </button>
          </li>
          <li className="flex gap-3 mb-6 cursor-pointer hover:text-green-900  ">
            <button className="flex gap-2 justify-center items-center ">
              <Icon name="menubook" />
              <p className="hover:text-green-900 text-gray-300">Книги</p>
            </button>
          </li>
          <li className="flex gap-3 mb-6 cursor-pointer hover:text-green-900  ">
            <button className="flex gap-2 justify-center items-center ">
              <Icon name="album" />
              <p className="hover:text-green-900 text-gray-300">Набори</p>
            </button>
          </li>
          <li className="flex gap-3 mb-6 cursor-pointer hover:text-green-900  ">
            <button className="flex gap-2 justify-center items-center ">
              <Icon name="sales" />
              <p className="hover:text-green-900 text-gray-300">Продажі</p>
            </button>
          </li>
          <li className="flex gap-3 mb-6 cursor-pointer hover:text-green-900 ">
            <button className="flex gap-2 justify-center items-center ">
              <Icon name="localization" />
              <p className="hover:text-green-900 text-gray-300">Локалізація</p>
            </button>
          </li>
